...
class Azure(Machinery):
    ...
    def _thr_create_vmss(self, vmss_name, vmss_image_ref, vmss_image_os):
        ...
        vmss_os_profile = models.VirtualMachineScaleSetOSProfile(  
            computer_name_prefix="cuckoo",  
            admin_username=None,  # Not used for specialized images  
            admin_password=None,  # Not used for specialized images  
            custom_data=None,  
        )  
